...
class bfd_test_match_tbl_match_spec_t:
  ...
  thrift_spec = (
    ...
    (2, TType.I32, 'ipv4_dstAddr_mask', None, None, ), # 2
  )

  def __init__(self, ipv4_dstAddr=None, ipv4_dstAddr_mask=None,):
    self.ipv4_dstAddr = ipv4_dstAddr
    self.ipv4_dstAddr_mask = ipv4_dstAddr_mask
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.I32:
          self.ipv4_dstAddr_mask = iprot.readI32();
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.ipv4_dstAddr is not None:
      ...
      oprot.writeFieldEnd()
    if self.ipv4_dstAddr_mask is not None:
      oprot.writeFieldBegin('ipv4_dstAddr_mask', TType.I32, 2)
      oprot.writeI32(self.ipv4_dstAddr_mask)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
  ...
  def validate(self):
    ...
    if self.ipv4_dstAddr_mask is None:
      raise TProtocol.TProtocolException(message='Required field ipv4_dstAddr_mask is unset!')
    return
...
class bfd_test_ipsa_modify_action_spec_t:
  ...
  def __init__(self, action_ipsa=None, action_port=None,):
...
class bfd_test_match_tbl_entry_desc_t:
  ...
  thrift_spec = (
    ...
    (3, TType.LIST, 'members', (TType.I32,None), None, ), # 3
  )

  def __init__(self, match_spec=None, priority=None, members=None,):
