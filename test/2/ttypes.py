...
class bfd_test_ipsa_modify_action_spec_t:
  ...
  def __init__(self, action_ipsa=None, action_port=None, action_stat_idx=None,):
...
class bfd_test_match_tbl_entry_desc_t:
  ...
  thrift_spec = (
    ...
    (2, TType.LIST, 'members', (TType.I32,None), None, ), # 2
  )

  def __init__(self, match_spec=None, members=None,):
